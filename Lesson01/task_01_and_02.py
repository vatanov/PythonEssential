...
class Book:
    ...
    def __str__(self):
        return 'Book: author: {}, name: {}, year: {}, genre: {}, comments: {}'.format (self.author, self.name, self.year, self.genre, self.comments)
...
comms = [Comment('comment 1'), Comment('comment 2'), Comment('comment 3')]
hh_guide_galxy = Book ('Adams Douglas', "The hitch hacker's guide to the galaxy", 1979, 'Science fiction', comms)

print (repr (python_crash_course))
print (python_crash_course)

print (learning_python == learning_python2)
print (python_crash_course == hh_guide_galxy)

print (hh_guide_galxy)